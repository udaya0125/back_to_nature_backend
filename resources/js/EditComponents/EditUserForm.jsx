...
const EditUserForm = ({
    ...
    useEffect(() => {
        ...
        reset({
            ...
            role:
                roles.find((role) => role.value === editingUser.role) || null,
            image: null,
        });

        setImageFile(null);
        setImagePreview(
            editingUser.image ? `${imgurl}/${editingUser.image}` : null,
        );
    }, [editingUser, imgurl, reset]);
    ...
    const onSubmit = async (data) => {
        ...
        try {
            setSubmitting(true);
            await axios.post(
                route("ouruser.update", { id: editingUser.id }),
                formData,
                {
                    headers: {
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div className="flex flex-col items-center">
                        ...
                        <p className="text-sm text-gray-500">
                            Click the camera icon to update the profile picture
                        </p>
                    </div>
